...
class ChoicesControllerTest < ActionController::TestCase
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post :create, choice: { answer_id: @choice.answer_id, device: @choice.device, question_id: @choice.question_id, user_id: @choice.user_id }
    end
  ...
  test "should update choice" do
    patch :update, id: @choice, choice: { answer_id: @choice.answer_id, device: @choice.device, question_id: @choice.question_id, user_id: @choice.user_id }
    assert_redirected_to choice_path(assigns(:choice))
  end
